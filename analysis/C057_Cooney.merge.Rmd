...
```{r tsne, fig.cap = "t-SNE plot constructed from the top PCs in the dataset. Each point represents a cell, coloured according to the `Sample`."}
set.seed(811771)
...
```{r tsne-more-factors, fig.cap = "t-SNE plot constructed from the top PCs in the dataset. Each point represents a cell, coloured to highlight the effect of various factors.", fig.asp = 1 / 3, layout = "l-body"}
bg <- dplyr::select(tsne_df, -Treatment)
ggplot(aes(x = x, y = y), data = tsne_df) +
