...
We use the `fry()` function from the `r BiocStyle::Biocpkg("edgeR")` R/Bioconductor package to perform a self-contained gene set test against the null hypothesis that none of the genes in the BCL-family gene set (supplied by James) are differentially expressed.
We can visualise the expression of the genes in any given set and in any given comparison by highlighting those genes on the MD plot and/or using a 'barcode plot'.
...
#### ignoring_cycling_subset {.panel-name}
