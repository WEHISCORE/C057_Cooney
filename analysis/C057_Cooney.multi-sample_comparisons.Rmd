...
knitr::opts_chunk$set(
  fig.path = "C057_Cooney.multi-sample_comparisons_files/")
```
...
```{r, results = "hide"}
dir.create(here("output", "DEGs", "cluster_labels"), recursive = TRUE)
...
```{r, results = "hide"}
dir.create(here("output", "DEGs", "ignoring_cluster_labels"), recursive = TRUE)
