...
Figures \@ref(fig:umap) and \@ref(fig:umap-faceted) show that five clusters are clearly distinguishable from each other and that the two additional clusters are a little easier to visually resolve.

```{r umap, fig.cap = "UMAP plot of the HTO data. Each point represents a cell with the colour explained in the legend.", fig.asp = 1}
...
Figure \@ref(fig:heatmap-average) shows that the five clearly distinguishable clusters correspond to the cells uniquely labelled with a single HTO while the two remaining clusters correspond to the sample labelled with all 5 HTOs and cells labelled with two or more HTOs.
