...
The processed *SingleCellExperiment* object is available (see [`data/SCEs/C057_Cooney_ignoring_unknowns.annotated.SCE.rds`](../data/SCEs/C057_Cooney_ignoring_unknowns.annotated.SCE.rdsCooney.annotated.SCE.rds)).
