...
saveRDS(
  sce,
  here("data", "SCEs", "C057_Cooney_ignoring_clusters.merged.SCE.rds"),
  compress = "xz")
```

The processed *SingleCellExperiment* object is available (see [`data/SCEs/C057_Cooney_ignoring_clusters.merged.SCE.rds`](../data/SCEs/C057_Cooney_ignoring_clusters.merged.SCE.rds)).
