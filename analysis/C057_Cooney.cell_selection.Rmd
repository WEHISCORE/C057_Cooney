...
<aside>
An interactive version of Figure \@ref(fig:refined-ambiguous-enriched-clusters-4-md-plot) is available from [`output/glimma-plots/refined-ambiguous-enriched-clusters-2-md-plot.html`](../output/glimma-plots/refined-ambiguous-enriched-clusters-2-md-plot.html).
</aside>
...
Reassuringly, most of the 'unlabelled' doublets come from the droplets currently labelled as originating from the `uninfected_3` sample, which was labelled with all 5 HTOs and for which it was difficult to identify 'labelled' doublets, and the `ambiguous` sample.
